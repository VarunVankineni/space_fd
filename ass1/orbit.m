...
r0 = [6837.432552 1868.795099 1455.480629];%6837432.552 i + 1868795.099 j + 1455480.629
%r0 = r0l.*0.358614366;
v0 = [-2.294079 6.758849 2.049468];%-2294.079 I + 6758.849 + 2049.468
...
Appendix D Page 19 of 101 10/27/09 9:07 AM
...
fprintf('\n Magnitude = %g km/s\n', norm(v0))
fprintf('\n Initial time = %g m.\n Final time = %g m.\n',0,tf/hours)
fprintf('\n The minimum altitude is %g km at time = %g m.',rmin-R, t(imin)/hours)
fprintf('\n The speed at that point is %g km/s.\n', v_at_rmin)
fprintf('\n The maximum altitude is %g km at time = %g m.',rmax-R, t(imax)/hours)
fprintf('\n The speed at that point is %g km/s\n', v_at_rmax)
fprintf('\n--------------------------------------------------------\n\n')
%...Plot the results:
% Draw the planet
