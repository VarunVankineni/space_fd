...
% ˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜
%
% This function calculates the geocentric equatorial position
% and velocity vectors of an object from radar observations of
% range, azimuth, elevation angle and their rates.
%
...
% R - geocentric equatorial position vector (km) of
% tracking site
% Rdot - inertial velocity (km/s) of site
% rho - slant range of object (km)
% rhodot - range rate (km/s)
% A - azimuth (degrees) of object relative to observation
% site
% Adot - time rate of change of azimuth (degrees/s)
% a - elevation angle (degrees) of object relative to
% observation site
...
% RA - topocentric equatorial right ascension of object
% (rad)
