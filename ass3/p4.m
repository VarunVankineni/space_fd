...
% from t0 to tf:
t0 = 0; tf = 150*days;              %Initial and final times (s)
...
plot(sma(:,1)/days,sma(:,2),'r','linewidth',2)
grid on 
grid minor
xlabel('Time (days)')
ylabel('Semi major axis(km)')
ylim([6500 6650]);
title('Decay of semi major axis ')
...
ap = -B*rho*...                %Acceleration due to drag (m/s^2)
